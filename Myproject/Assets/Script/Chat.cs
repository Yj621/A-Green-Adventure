...
public class Chat : MonoBehaviour
{
    ...
    List<string> chat8_1 = new List<string>() { "내 동생?", "맞아, 동생은 도시에 살고 있어", "안부 전해줘서 고마워", "여기는 이렇게 홯폐하고 오염되었지만", "옆 도시는 정말 번화가라던데", "나 대신 구경해보고 얘기해 줄래?" };
    List<string> chat8_2 = new List<string>() { "고마워, 이건 내 선물이야" };
